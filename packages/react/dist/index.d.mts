...
declare function ActionSheet({ labelButton, children }: ActionSheetProps): react_jsx_runtime.JSX.Element;
declare namespace ActionSheet {
    var displayName: string;
}

declare const BottomBox: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        red100: string;
...
interface CardsProps extends ComponentProps<typeof CardBox> {
    balanceValue: number;
    cardNumber: string;
    expiryDate: string;
    cvv: string;
...
interface ComponentsHeaderProps extends ComponentProps<typeof ComponentHeader> {
    title: string;
    pageLink: string;
    labelLink: string;
}
...
declare function Dropdown({ options, label }: DropdownProps): react_jsx_runtime.JSX.Element;

declare const AppFooter: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        red100: string;
...
interface FooterProps extends ComponentProps<typeof AppFooter> {
    as?: ElementType;
}
...
declare function HeaderComponent({ children, activeModal, activeNotifications, notificationLink }: HeaderProps): react_jsx_runtime.JSX.Element;

declare const LoadingWrapper: _stitches_react_types_styled_component.StyledComponent<"div", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        red100: string;
...
interface LoaderProps extends ComponentProps<typeof LoadingWrapper> {
    logo: string;
}
declare function Loader({ logo }: LoaderProps): react_jsx_runtime.JSX.Element;
...
declare function Modal({ children, onClose, show }: ModalProps): react_jsx_runtime.JSX.Element | null;
...
interface SavingGoalsProps extends ComponentProps<typeof Goals> {
    goal: string;
    category: string;
    amount: number;
    locked: number;
...
interface StatsProps extends ComponentProps<typeof StatBox> {
    title: string;
    value: number;
    typeValue: string;
}
...
interface StatsBoxProps extends ComponentProps<typeof StatsBox> {
    as?: ElementType;
}

declare const TransactionsBox: _stitches_react_types_styled_component.StyledComponent<"section", {}, {}, _stitches_react_types_css_util.CSS<{}, {
    colors: {
        white: string;
        black: string;
        red100: string;
...
interface TransactionsProps extends ComponentProps<typeof TransactionsBox> {
    title: string;
    category: string;
    amount: number;
    type: string;
